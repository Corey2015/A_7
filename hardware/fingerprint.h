...
#define FINGERPRINT_HARDWARE_MODULE_ID "dfs747.fingerprint"
...
typedef enum fingerprint_error {
    ...
    FINGERPRINT_ERROR_DUPLICATE=1000,
    FINGERPRINT_ERROR_NOT_ENABLED=1001,
    FINGERPRINT_ERROR_NO_ENROLLED=1002,	
    FINGERPRINT_ERROR_COUNTOUT = 1003
} fingerprint_error_t;
...
typedef enum fingerprint_acquired_info {
    ...
    FINGERPRINT_ACQUIRED_WAIT_FINGERDOWN = 1000,
    FINGERPRINT_ACQUIRED_FINGERDOWN = 1001,
    FINGERPRINT_ACQUIRED_WAIT_FINGERUP = 1002,
    FINGERPRINT_ACQUIRED_FINGERUP	= 1003,
    FINGERPRINT_ACQUIRED_KEY_LEFT	= 1004,
    FINGERPRINT_ACQUIRED_KEY_RIGHT	= 1005,
    FINGERPRINT_ACQUIRED_KEY_UP		= 1006,
    FINGERPRINT_ACQUIRED_KEY_DOWN	= 1007,
	FINGERPRINT_ACQUIRED_KEY_CLICK     = 1008,
	FINGERPRINT_ACQUIRED_KEY_DBLCLICK  = 1009,
	FINGERPRINT_ACQUIRED_KEY_LONG   = 1010,
...
typedef struct fingerprint_device {
    ...
    /*
     * calibrate sensor detect and save backgroud image.
     * Function return: 0 on success
     *                  or a negative number in case of error, generally from the errno.h set.
     */
    int (*calibrate)(struct fingerprint_device *dev, const char *store_path);
